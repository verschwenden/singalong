...
class SongsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('songs')->insert([
            'lang_code' => 'he',
            'times' => '15.03,16.86,18.8,20.6,22.38,26.12,30.19,32.1,34.02,35.67,37.78,39.5,41.6,60.41,62.62,64.47,66.37,68.01,70.13,72.05,73.46,77.36,79.26,81.13,82.46,83.48,84.91,89.01,92.76,96.57,100.36,127.46,131.06,134.69,138.44,144.64,148.25,152.03,155.61,157.57,159.93,163.33,167.12,170.86',
            'title' => 'סמי וסומו',
            'videocode' => 'jnQBAn4CXJU',
        ...
        DB::table('songs')->insert([
            'lang_code' => 'he',
            'times' => '27.63,34.4,40.77,54.23,60.19,67.62,78.3,85.24,91.8,98.34,117.8,123.95,130.56,136.49,145.1,151.83,158.39,164.76,198.43,205.22,211.83,218.16,225.24,228.21,233.22,236.35,238.31,241.52,246.78,249.8,251.48,254.86,259.93,263.18,266.6',
            'title' => 'ארוחת יום שישי',
            'videocode' => 'l_AqvKs53lQ',
            'lyrics' => "הורדתי את הציורים מהקירות \nנתתי את הספה הלבנה \nהפילים הקטנים מהעץ עדיין עומדים בשורה \nהגינה שלך מתפרעת בעדינות \nאני גוזמת את הורדים \nבקרוב קטיף אחרון של תות ותאנים \n\nאני יכולה לראות אותך רק בעיניים עצומות \nאת עולה דמעות יורדות \nאולי רק נסעת לחוצל ארץ בקרוב תחזרי \nמזוודה מלאה מתנות לכולם וארוחת יום שישי \n\nבינתיים אני כותבת בחדר שהיה שלך \nוהאוח שמגיע כל קיץ \nאחריו יבוא הסתיו \nותתחיל עוד שנה בלעדייך\n\nאני יכולה לראות אותך רק בעיניים עצומות \nאת עולה דמעות יורדות \nאולי רק נסעת לחוצל ארץ בקרוב תחזרי \nמזוודה מלאה מתנות לכולם וארוחת יום שישי \n\nאני יכולה לראות אותך רק בעיניים עצומות \nאת עולה דמעות יורדות \nאולי רק נסעת לחוצל ארץ בקרוב תחזרי \nמזוודה מלאה מתנות לכולם וארוחת יום שישי \n\nלא יהיה צלצול של טלפון \nלא מכתב לא גלויה \nלא ביקור חטוף \nלא נשיקה \n\nלא יהיה צלצול של טלפון \nלא מכתב לא גלויה \nלא ביקור חטוף \nלא נשיקה \n\nלא יהיה צלצול של טלפון \nלא מכתב לא גלויה \nלא ביקור חטוף \nלא נשיקה \n\nיבשה"
        ]);

        DB::table('songs')->insert([
            'lang_code' => 'he',
            'times' => '10.55,14.31,17.02,19.52,22.92,28.52,35.72,42.32,48.32,52.21,53.72,56.91,60.93,64.92,67.32,69.93,73.53,79.04,139.93,143.68,146.58,148.88,152.24,157.92',
            'title' => 'אם תלך',
            'videocode' => 'cXQ6uVJtH_Q',
            'lyrics' => "אם תלך מי יחבק אותי ככה\nמי ישמע אותי בסוף היום\nמי ינחם וירגיע\nרק אתה יודע\n\nואם תלך למי אחכה בחלון בשמלה של חג \nשיגיע יחבק אותי ככה כמו שאתה מגיע\n\nכשתלך לשמש אצא, בשדה המוזהב, בוקר וערב,\nירח יאיר את פני שחולמות כל היום רק עליך\n\nוכשתבוא תישא אותי בשתי ידיך, \nמשדה לנהר\nתרחוץ את פני ותגיד לי מילים\nכמו שרק אתה יודע\n\nאם תלך מי יחבק אותי ככה\nמי ישמע אותי בסוף היום\nמי ינחם וירגיע\nרק אתה יודע\n\nואם תלך למי אחכה בחלון בשמלה של חג \nשיגיע יחבק אותי ככה כמו שאתה מגיע\n\nאם תלך מי יחבק אותי ככה\nמי ישמע אותי בסוף היום\nמי ינחם וירגיע\nרק אתה יודע\n\nואם תלך למי אחכה בחלון בשמלה של חג \nשיגיע יחבק אותי ככה כמו שאתה מגיע"
        ]);

        DB::table('songs')->insert([
            'lang_code' => 'he',
            'times' => '10.2,17.51,22.29,28.07,34.38,40.16,45.27,54.62,63.01,72.07,77.42,84.51,91.93,96.93,102.9,109.45,113.94,119.41,128.94,137.81,146.92,152.52,176.96,186.29,192.77,200.38,205.99,210.77',
            'title' => 'אל תאמר',
            'videocode' => 'WyDloWawVWo',
            'lyrics' => "כל הלילות שהיו לי איתך\nאגרתי את חום גופך\nלחורף המר\nחיוך אחד שזוכרת לך\nניצח את השכחה\nבגשם הקר\nאל תאמר אל תאמר אל תאמר לי בואי\nאל תאמר אל תאמר אל תאמר לי לא\nאל תאמר אל תאמר אל תאמר לי בואי\nאל תאמר אל תאמר אל תאמר לי לבוא\nלבוא לבוא\nשמה את הראש בין עננים\nתקווה לחלום נעים\nבאמצע היום\nכל שנייה מלוחה של לבד\nהיא פסיק בסיפור אחד\nשיהיה רק סוף טוב...\nאל תאמר אל תאמר אל תאמר לי בואי\nאל תאמר אל תא+מר אל תאמר לי לא\nאל תאמר אל תאמר אל תאמר לי בואי\nאל תאמר אל תאמר אל תאמר לי לבוא\nלבוא לבוא\nאל תאמר אל תאמר אל תאמר לי בואי\nאל תאמר אל תאמר אל תאמר לי לבוא\nלבוא לבוא\nכל הלילות שהיו לי איתך\nמאירים לי את החשיכה\nבריח שלך"
        ]);
